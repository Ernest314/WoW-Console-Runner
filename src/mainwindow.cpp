...
QPalette MainWindow::dark_palette()
{
	...
	// QPalette::Disabled
	{
		...
		palette.setColor(QPalette::Disabled, QPalette::WindowText,		QColor(208,208,208));
		...
		palette.setColor(QPalette::Disabled, QPalette::ToolTipText,		QColor(208,208,208));
		palette.setColor(QPalette::Disabled, QPalette::PlaceholderText,	QColor(138, 94,162));
		palette.setColor(QPalette::Disabled, QPalette::Text,			QColor(208,208,208));
		...
		palette.setColor(QPalette::Disabled, QPalette::BrightText,		QColor(138, 94,162));
